...
import { D as DEFAULT_BUTTONS, S as STRAPI_MEDIA_BUTTON_NAME } from "./index-CJqMBVsT.mjs";
...
const JoditContainer = styled.div`
  ...
  .jodit-toolbar__box {
    border-color: ${({ theme }) => theme.name === "dark" ? "#4a4a6a" : theme.colors.neutral600};
  }
...
//# sourceMappingURL=JoditInput-BCqyaWCJ.mjs.map
