...
import { D as DEFAULT_BUTTONS, S as STRAPI_MEDIA_BUTTON_NAME } from "./index-C-MSWb--.mjs";
...
const JoditContainer = styled.div`
  ...
  .jodit-toolbar-editor-collection {
    background: ${({ theme }) => theme.name === "dark" ? "#4a4a6a" : theme.colors.neutral100};
    border-color: ${({ theme }) => theme.name === "dark" ? "#4a4a6a" : theme.colors.neutral200};
  }
...
//# sourceMappingURL=JoditInput-on3aJ5Y1.mjs.map
