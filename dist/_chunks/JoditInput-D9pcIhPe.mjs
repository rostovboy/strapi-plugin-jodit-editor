...
import { D as DEFAULT_BUTTONS, S as STRAPI_MEDIA_BUTTON_NAME } from "./index-DL6rvGKb.mjs";
...
const JoditContainer = styled.div`
  ...
  .jodit-toolbar__box {
    background: ${({ theme }) => theme.name === "dark" ? "#4a4a6a" : theme.colors.neutral200};
  }
...
//# sourceMappingURL=JoditInput-D9pcIhPe.mjs.map
