...
import { D as DEFAULT_BUTTONS, S as STRAPI_MEDIA_BUTTON_NAME } from "./index-CU9-0MlF.mjs";
...
const JoditContainer = styled.div`
  ...
  .jodit-toolbar-editor-collection {
    background: ${({ theme }) => theme.name === "dark" ? "#4a4a6a" : theme.colors.neutral150};
  }
...
//# sourceMappingURL=JoditInput-RuhsNnpM.mjs.map
